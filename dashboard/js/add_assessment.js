...
function change_lang(lang) {
    ...
    if (lang == 'en') {
        ...
        $('#added_assessments th:nth-of-type(5)').text('Edit');
    } else {
        $('html').attr('lang','ar');
    ...
    if (my_validation()) {
        ...
        $.ajax({
            ...
            data: {a_id:value,
                ...
                End_d:e},
            success: function(data){
                if (added_assessments_counter == 0) $('#added_assessments').fadeIn();
                added_assessments_counter += 1;
                $('#added_assessments #desktop_table').append($('<tr id="'+ added_assessments_counter+'"></tr>'));
                ...
                $('#added_assessments #desktop_table tbody tr:last-of-type').append($('<td><a href="" onclick="">Edit</a></td>'));
                $('#added_assessments #desktop_table tbody tr:last-of-type').fadeIn();
            }
        });
    }
}
